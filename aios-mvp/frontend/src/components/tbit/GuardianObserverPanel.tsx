...
import { Shield, AlertTriangle, CheckCircle, XCircle, Eye, EyeOff, Bell, BellOff, Search, RefreshCw, Filter, Zap, Activity, ShieldAlert, Users, Database } from "lucide-react";
      ...
      {state.selectedEvent && (
        <div className="detail-panel">
          ...
          <div className="detail-content">
            ...
            {!state.selectedEvent.acknowledged && <div className="detail-actions"><button className="btn btn-primary" onClick={() => acknowledgeEvent(state.selectedEvent.id)}><CheckCircle size={14} /> Acknowledge</button></div>}
          </div>
        </div>
      )}
