 ...
 */
export async function createTestVault(spaceId) {
 ...
 */
export async function createTestVaults(count) {
    const vaults = [];
 ...
 */
export async function cleanupTestVaults(vaults) {
    await Promise.all(vaults.map((v) => v.cleanup()));
}
/**
 * Writes a test file to the vault
 */
export async function writeTestFile(vault, relativePath, content) {
 ...
 */
export async function readTestFile(vault, relativePath) {
    const fullPath = join(vault.spacesRoot, relativePath);
 ...
 */
export async function createSeededTestVault(seedData) {
 ...
 */
export async function createTestVaultWithRotation() {
    const vault = await createTestVault();
 ...
 */
export async function createLargeTestVault(recordCount = 10000) {
